...
public class WeatherDao {
    ...
    final private static String ID_FIELD_NAME           = "id";         //id
     ...
     * sql
     */
    final private static String SQL_FIND_WEATHER = "SELECT * FROM weather WHERE city_name=?";
    final private static String SQL_FIND_WEATHER_ALL = "SELECT * FROM weather";
    ...
    public List<Weather> findall(){
        return this.jdbcTemplate.query(SQL_FIND_WEATHER_ALL, new WeatherRowMapper());
    }
