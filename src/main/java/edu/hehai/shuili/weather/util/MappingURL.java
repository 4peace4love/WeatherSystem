...
public class MappingURL {
     ...
     * page url
     */
    public final static String ROOT_PAGE                             = "/";
    public final static String INDEX_PAGE                            = "/index";
    public final static String LOGIN_PAGE                            = "/login";
    public final static String LOGOUT_PAGE                            = "/logout";
    public final static String CITY_LIST_PAGE                        = "/city/index";
    public final static String CITY_ADD_PAGE                         = "/city/add";
    public final static String CITY_DEL_PAGE                         = "/city/delete";
    public final static String WEATHER_LIST_PAGE                     = "/weather/list";
    public final static String WEATHER_DOWNLOAD_PAGE                 = "/weather/download";
    public final static String WEATHER_LOG_PAGE                      = "/weather/log";
    public final static String WEATHER_DOWNLOAD_SINGLE_PAGE          = "/weather/download";
    public final static String WEATHER_DOWNLOAD_ZIP_PAGE             = "/weather/downloadAll";

    /**
     * API base url
     */

    public final static String CITY_BASE_URL                        = "api/city";
    public final static String USER_BASE_URL                        = "api/user";
    public final static String REGION_BASE_URL                      = "api/region";
    public final static String WEATHER_BASE_URL                     = "api/weather";
